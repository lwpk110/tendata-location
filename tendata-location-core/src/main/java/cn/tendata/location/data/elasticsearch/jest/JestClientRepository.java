package cn.tendata.location.data.elasticsearch.jest;
...
public interface JestClientRepository<T extends AbstractElasticsearchEntity, ID extends Serializable> {
