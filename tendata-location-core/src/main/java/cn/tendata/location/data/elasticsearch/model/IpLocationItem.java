package cn.tendata.location.data.elasticsearch.model;
...
public class IpLocationItem extends AbstractElasticsearchEntity {
    public static final String RANGE_FIELD_LTE = "lte";
    public static final String RANGE_FIELD_GTE = "gte";
    ...
    public static class IpLocationDocumentBuilder {
        ...
        public IpLocationDocumentBuilder ipCidr(Object cidr){
            ipLocationDocument.setIpCidr(cidr);
            return this;
        }

        public IpLocationItem build() {
            Assert.notNull(ipLocationDocument.getIpCidr(),"ip cidr not be null");
